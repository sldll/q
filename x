...
😈
pacstrap -KP /mnt base networkmanager sudo vi vim alacritty xorg xorg-xinit i3 ttf-nerd-fonts-symbols noto-fonts noto-fonts-emoji terminus-font openssh inetutils exfatprogs ripgrep jq bc less eza bat fzf zoxide net-tools zram-generator intel-media-driver vulkan-intel intel-gmmlib pipewire pipewire-alsa pipewire-jack pipewire-pulse brightnessctl playerctl rofi chromium firefox firefox-ublock-origin btop mousepad flatpak linux linux-firmware-intel linux-firmware-atheros intel-ucode
